...
const lessonsDir = path.join(root, 'src', 'pages', 'modules', 'presupuesto', 'lessons');
// La lógica del Overview está en el componente unificado del module-kit
...
for (const lessonId of lessonIds) {
  checks.push({
    ...
    ok: appContent.includes(`/app/presupuesto/lesson/${lessonId}`),
  });
}
...
console.log('Module 1 static checklist');
